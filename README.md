...
> 제 Main System  **'Rachel'**과 함께 Infra Security과 취약점 분석의 World를 탐구합니다. Artist Rachel의 긍정적인 Energy를 기술적 완벽함으로 승화시키는 것이 제 목표입니다.

---

### 🔍 Technical Focus
- **Infrastructure Security:** Linux 기반 Server 요새화 및 Azure Cloud 아키텍처 Security
- **Network Analysis:** Cisco 장비 및 트래픽 분석을 통한 위협 탐지
- **Automated DevSecOps:** CI/CD Pipeline 내 Security 취약점 자동 점검
...
* **[C-Calculator CI/CD](https://github.com/ikarams)**
    - C언어 알고리즘 기반 계산기의 자동 build 및 Unit Test 자동화 
