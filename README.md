...
> 제 Main System  **'Rachel'**과 함께 Infra Security과 취약점 분석의 World를 탐구합니다. Artist Rachel의 긍정적인 Energy를 기술적 완벽함으로 승화시키는 것이 제 Subject입니다.
...
- 🛠️ **Practical Skills:** 정보기기운용기능사 실기 대비 ( Network 설정 및 장비 유지보수)
